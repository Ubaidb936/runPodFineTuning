...
data = data.map(lambda samples: tokenizer(samples["text"]),num_proc=cpu_count(), batched=True)
...
model.push_to_hub("Financial_Analyst", token="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")
tokenizer.push_to_hub("Financial_Analyst",token="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")
